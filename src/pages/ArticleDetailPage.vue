          ...
          <div class="w-full">
            ...
            <div class="flex w-full border-t border-gray-100">
              <div class="mt-3 mx-5 flex flex-row">
                <div class="flex text-gray-700 font-normal text-sm rounded-md mb-2 mr-4 items-center whitespace-nowrap">Comments:<div class="ml-1 text-gray-400 font-thin text-ms"> 30</div>
                </div>
                <div class="flex text-gray-700 font-normal text-sm rounded-md mb-2 mr-4 items-center whitespace-nowrap">Views: <div class="ml-1 text-gray-400 font-thin text-ms"> 60k</div>
                </div>
              </div>
              <div class="mt-3 mx-5 w-full flex justify-end">
                <div class="flex text-gray-700 font-normal text-sm rounded-md mb-2 mr-4 items-center whitespace-nowrap">Likes: <div class="ml-1 text-gray-400 font-thin text-ms"> 120k</div>
                </div>
              </div>
            </div>
